...
import RealEstateListingForm from '@/app/components/listings/RealEstateListingForm';
import LoadingSpinner from '@/app/components/common/LoadingSpinner';

export default function EditRealEstateListingPage({ params }) {
  ...
  return (
    <div className="bg-[#F4F5F4] min-h-screen">
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
        <RealEstateListingForm listingId={params.id} />
      </div>
    </div>
  );
}
